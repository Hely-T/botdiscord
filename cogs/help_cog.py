...
HELP_CATEGORIES = [
    ...
    },
    {
        ...
        "commands": [
            ...
            {"name": "donate", "description": "Tạo QR donate, reload số dư và gửi lời cảm ơn theo kênh đã set", "usage": "<amount> | reload [id|code] | config ...", "aliases": ["dn"]},
            ...
            {"name": "naptien", "description": "Tạo QR nạp cash và reload số dư ACB", "usage": "<amount> | reload [id|code] | config ...", "aliases": ["nap"]},
