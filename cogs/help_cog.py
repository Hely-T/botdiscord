...
HELP_CATEGORIES = [
    ...
    },
    {
        ...
        "commands": [
            ...
            {"name": "log", "description": "Setup log chat, voice, server và member leave/out", "usage": "[chat|voice|server|leave #channel] | off <loại> | voice announce|message|embed", "aliases": ["logs"]},
        ...
        "slash_commands": [
            ...
            {"name": "log", "description": "Một slash tổng để setup log chat/voice/server/member", "usage": "action: show|set|off|test|voice-announce|voice-message|voice-embed", "aliases": []},
