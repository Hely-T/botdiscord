...
HELP_CATEGORIES = [
    ...
    },
    {
        ...
        "commands": [
            ...
            {
                "name": "log",
                "description": "Setup log toàn server: chat, voice, channel, server và member join/leave",
                "usage": "[chat|voice|channel|server|join #channel] | all #channel | off <loại> | voice room|joinmsg|leavemsg|embed",
                "aliases": ["logs"],
            },
